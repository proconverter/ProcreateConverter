...
<html lang="en" style="height: 100%">
    <head>
        ...
        <meta charset="utf-8">
        <title>flask_app.py : /home/proconvert/mysite/flask_app.py : Editor : proconvert : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="flask_app.py : /home/proconvert/mysite/flask_app.py : Editor : proconvert : PythonAnywhere">
        ...
        <link rel="stylesheet" href="/static/CACHE/css/output.b9a4961a16f7.css" type="text/css"><link rel="stylesheet" href="/static/CACHE/css/output.443587eadd02.css" type="text/css" media="screen">

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "I6ZfhvFLZKL7ldpteBDCMtpeBXtVmNANEtTOjULfCG8jpzpFz7iF1P0QCd6UbI4c";
        </script>
        <script src="/static/CACHE/js/output.b336be555fe1.js"></script>
        

        <script src="/static/CACHE/js/output.15248a5c28be.js"></script>
        
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          file: "/user/proconvert/files/home/proconvert/mysite/flask_app.py",
          check_hash: "/user/proconvert/files/home/proconvert/mysite/flask_app.py",
          update_editor_mode_preference: "/user/proconvert/account/update_editor_mode_preference",
          console_api: "/api/v0/user/proconvert/consoles/",
        });
        var filename = "/home/proconvert/mysite/flask_app.py";
        var hash = "61685c320d467481d1397d378c918437";
        ...
        Anywhere2.initializeFileSharingOptions(
          ...
          {
            url: "/api/v0/user/proconvert/files/sharing/",
            csrfToken: "I6ZfhvFLZKL7ldpteBDCMtpeBXtVmNANEtTOjULfCG8jpzpFz7iF1P0QCd6UbI4c",
            path: "/home/proconvert/mysite/flask_app.py"
          }
        );
  ...
  <div id="id_editor_toolbar">
    ...
    <div class="pull-left">
      <span id="id_breadcrumbs_div"><a class="breadcrumbs_link breadcrumb_entry" href="/user/proconvert/files/" target="_parent">/</a><a class="breadcrumbs_link breadcrumb_entry" href="/user/proconvert/files/home" target="_parent">home</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/proconvert/files/home/proconvert" target="_parent">proconvert</a><span class="breadcrumb_entry">/</span><a class="breadcrumbs_link breadcrumb_entry" href="/user/proconvert/files/home/proconvert/mysite" target="_parent">mysite</a><span class="breadcrumb_entry">/</span><wbr><span class="breadcrumb_entry breadcrumb_terminal">flask_app.py</span></span>
      ...
      <div id="id_editor_buttons_right" class="form-inline">
        ...
        <button id="id_display_sharing_options" class="btn btn-default" data-toggle="modal" data-target="#id_file_sharing_modal" title="Get a URL to share this file">
          ...
          <button class="btn btn-info run_button" title="Save &amp; Run (Ctrl + R)">
            ...
            <form class="reload_web_app" style="display: flex" method="POST" action="/user/proconvert/webapps/proconvert.pythonanywhere.com/reload">
              <button class="btn btn-default" type="submit" title="Reload proconvert.pythonanywhere.com">
  ...
  <li class=""><a id="id_dashboard_link" href="/user/proconvert/">Dashboard</a></li>
  <li class=""><a id="id_consoles_link" href="/user/proconvert/consoles/">Consoles</a></li>
  <li class=""><a id="id_files_link" href="/user/proconvert/files/home/proconvert">Files</a></li>
  <li class=""><a id="id_web_app_link" href="/user/proconvert/webapps/">Web</a></li>
  <li class=""><a id="id_tasks_link" href="/user/proconvert/tasks_tab/">Tasks</a></li>
  <li class=""><a id="id_databases_link" href="/user/proconvert/databases/">Databases</a></li>
...
<li class=""><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <li class=""><a href="/user/proconvert/account/" target="_parent" class="account_link">Account</a></li>
  <li class="">
    <form action="/logout/" method="POST" target="_parent">
      <input type="hidden" name="csrfmiddlewaretoken" value="I6ZfhvFLZKL7ldpteBDCMtpeBXtVmNANEtTOjULfCG8jpzpFz7iF1P0QCd6UbI4c">
  ...
  <div>
    <div id="id_ide_split_panes">
        ...
        <div id="id_editor">from flask import Flask, render_template, request
...
def home():
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 well">
            ...
            2 consoles.  You can
            have more if you
            <a href="/user/proconvert/account/">upgrade your account</a>!

            <p>
            Alternatively, if you don't feel like paying us more money, you
            can <a href="/user/proconvert/consoles/">kill some consoles on your Consoles page</a>.
        </div>
    </div>
</div>
